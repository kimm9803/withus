...
<body>
	...
	<main style="display: flex; width: 75%; margin: 0 auto; margin-top: 100px;">
	      ...
	      <div class="rightArea" style="flex: 4;">
	         ...
	         <div style="margin-top: 40px; text-align: center;"><h2 style="font-weight: bold;">그룹 전체 목록</h2></div>
			...
			<div style="text-align: center; margin-top: 40px;">
				<ul class="p-ul">
					...
					<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}"
						var="idx">
						<li class="p-li"><a class="p-a" href="/admin/group/list${pageMaker.makeQuery(idx)}">${idx}</a></li>
					</c:forEach>
