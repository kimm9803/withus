...
<body>
	...
	<main style="display: flex; width: 75%; margin: 0 auto; margin-top: 100px;">
	      ...
	      <div class="rightArea" style="flex: 4;">
	         ...
	         <div style="margin-top: 40px; text-align: center;"><h2 style="font-weight: bold;">회원 신고 내역</h2></div>
					...
					<tbody>
						<c:forEach items="${mReportList}" var="report" varStatus="loop">
							<tr class="clickable-row"  style="text-align: center;"
								data-href="/admin/user/reportview/${report.mreportId}">
								<td>${loop.index + 1}</td>
			...
			<div style="text-align: center; margin-top: 40px;">
				<ul class="p-ul">
					...
					<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}"
						var="idx">
						<li class="p-li"><a class="p-a" href="/admin/user/report-list${pageMaker.makeQuery(idx)}">${idx}</a></li>
					</c:forEach>
