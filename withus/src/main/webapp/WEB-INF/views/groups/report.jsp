        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">그룹 신고</h5>
                </div>
                <div class="card-body">
                    <!-- 여기에 폼 내용 추가 -->
                    <form  id="reportForm" action="/groups/report/${gno}" method="post">
                        <input type="hidden" name="gno" value="${gno}">
					    <!-- 폼 필드들과 라벨 추가 -->
					    <div class="mb-3">
					        <label for="memberid" class="form-label">신고자</label>
					        <input type="text" class="form-control bg-light" id="memberid" name="memberid" value="${memberid}" readonly>
					    </div>
					    
					    <div class="mb-3">
					        <label for="gname" class="form-label">신고그룹</label>
					        <input type="text" class="form-control bg-light" id="gname" value="${gname}" readonly>
					    </div>					    
					    <div class="mb-3">
