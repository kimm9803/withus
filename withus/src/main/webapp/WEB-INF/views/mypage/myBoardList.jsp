	      ...
	      <div class="rightArea" style="flex: 4;">
	         ...
	         <div style="margin-top: 40px;">
	         	<table class="table table-hover">
					...
					<tbody>
					<c:forEach items="${myCreateBoardList}" var="myCreBrdList" varStatus="loop">
						<tr class="clickable-row"  data-href="" style="text-align: center;">			
							<td>${loop.index + 1}</td>
			                <td>${myCreBrdList.gname}</td>
			                <td>${myCreBrdList.title}</td>
			                <td>${myCreBrdList.gbregdate}</td>
			                <td>${myCreBrdList.gbcatename}</td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
